...
CONTEXT_COMPRESSION_ENABLED = _env_bool("CONTEXT_COMPRESSION_ENABLED", True)
CONTEXT_MAX_MESSAGES = _env_int("CONTEXT_MAX_MESSAGES", 20)
CONTEXT_MAX_TOKENS = _env_int("CONTEXT_MAX_TOKENS", 4000)
CONTEXT_KEEP_RECENT_MESSAGES = _env_int("CONTEXT_KEEP_RECENT_MESSAGES", 8)
CONTEXT_KEEP_RECENT_TOKENS = _env_int("CONTEXT_KEEP_RECENT_TOKENS", 1600)
...
SEMANTIC_CACHE_EXTRACTION_MODEL = os.getenv(
    "SEMANTIC_CACHE_EXTRACTION_MODEL", "qwen3.5-flash"
)
SEMANTIC_CACHE_INDEX_NAME = os.getenv(
    "SEMANTIC_CACHE_INDEX_NAME", "mg:semcache:index:v2"
)
